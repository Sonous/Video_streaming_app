...
import { View, TextInput, Button, StyleSheet, FlatList, Text, Dimensions, TouchableOpacity, Image } from 'react-native';
...
export default function Search({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            <TextInput style={styles.input} value={query} onChangeText={setQuery} placeholder="Nhập từ khóa tìm kiếm" />
